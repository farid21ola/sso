...
import (
	...
	"github.com/farid21ola/sso/internal/lib/jwt"
	"github.com/farid21ola/sso/internal/lib/logger/sl"
...
// Login checks if user with this credential exists in the system
//
...
func (a *Auth) IsAdmin(
	...
	if err != nil {
		if errors.Is(err, storage.ErrAppNotFound) {
			log.Warn("app id not found", sl.Err(err))
		...
		if errors.Is(err, storage.ErrUserNotFound) {
			...
			return false, fmt.Errorf("%s: %w", ErrUserNotFound)
		}
